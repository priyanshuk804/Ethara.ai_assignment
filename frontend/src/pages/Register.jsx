  ...
  return (
    <div className="flex items-center justify-center min-h-[85vh] relative z-10">
      ...
      <div className="glass-card p-10 rounded-2xl w-full max-w-md relative animate-float">
        <div className="absolute -top-5 -right-5 bg-gradient-to-br from-pink-500 to-purple-500 w-16 h-16 rounded-2xl rotate-12 flex items-center justify-center shadow-lg border border-white/20 z-20">
          <Sparkles className="text-white w-8 h-8" />
        </div>

        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-slate-800/80 border border-purple-500/30 text-purple-400 mb-6 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
            <UserPlus size={36} />
          </div>
          <h2 className="text-3xl font-bold text-white mb-2">Create Account</h2>
          <p className="text-slate-400">Join Ethara Tasks today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              type="text"
              required
              className="w-full px-5 py-3.5 rounded-xl glass-input outline-none"
          ...
          <div>
            ...
            <select
              className="w-full px-5 py-3.5 rounded-xl glass-input outline-none [&>option]:bg-slate-800 [&>option]:text-white cursor-pointer"
              value={role}
